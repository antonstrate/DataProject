...
- `task2_model.py` — `IncomeModel` and `gini`: The IncomeModel used in Task 2.
  Gini is a function used to calculate the Gini Coefficient in Task 2.
...
Open `Results.ipynb` in the same folder as `task2_model.py`
